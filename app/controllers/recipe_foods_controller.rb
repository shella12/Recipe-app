class RecipeFoodsController < ApplicationController
  ...
  def update
    ...
    redirect_to recipes_detail_path(params[:id]), notice: 'Ingredient has been updated successfully!'
  end

  def destroy
    @recipe = RecipeFood.find(params[:ingredient_id]).destroy!
    redirect_to recipes_detail_path(params[:id]), notice: 'Ingredient has been deleted successfully!'
  end
end
